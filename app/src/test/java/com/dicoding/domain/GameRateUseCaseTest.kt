...
//        gameRateUseCase = GameRateInteractor(iGameRateRepository)
        ...
        gameRateUseCase = GameRateInteractor(iGameRateRepository)
        Mockito.`when`(iGameRateRepository.getAllGameRate()).thenReturn(dummyGameRateList)
    }
    ...
    fun getAllGameRateTest(){
        ...
        Mockito.verify(iGameRateRepository).getAllGameRate()
        Mockito.verifyNoMoreInteractions(iGameRateRepository)
        Assert.assertEquals(gameRate, dummyGameRateList)
